...
\renewcommand{\glossarypreamble}{\label{appendix:glos}}
...
% TODO: fix toclevel and chapter sub
\indexsetup{level=\section*,toclevel=section}
\makeindex[title=Terms and Explanations Index]
...
\includepdf[pages=-]{inc/appendices/vision.pdf}

\chapter{Requirements document}
\label{appendix:requirement}
\includepdf[pages=-]{inc/appendices/requirement.pdf}

\chapter{Feature discussion and decisions}
\label{appendix:plansndecisions}
\includepdf[pages=-]{inc/appendices/permissionskubernetes.pdf}

\chapter{Autumn project report}
\label{appendix:autumn}
\includepdf[pages=-]{inc/appendices/cion-report.pdf}

\chapter{User test}
\label{appendix:usertest}
\includepdf[pages=-]{inc/appendices/user_test.pdf}
...
\section{cion-api}
\includepdf[pages=-]{inc/appendices/cion-api-code-doc.pdf}

\input{inc/appendices/system-doc/system-doc.tex}
\input{inc/appendices/projecthandbook.tex}
\input{inc/appendices/terms-explanations.tex}
